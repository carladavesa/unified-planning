...
PDDL_DIR = os.path.join(os.path.dirname(__file__), 'domains/settlers', 'handcrafted')
READ_INSTANCE_SCRIPT = os.path.join(os.path.dirname(__file__), 'domains/settlers', 'read_instance.py')
